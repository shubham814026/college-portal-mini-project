...
-- -----------------------------------------------
ALTER TABLE files ADD COLUMN IF NOT EXISTS branch VARCHAR(50) DEFAULT NULL;
ALTER TABLE files ADD COLUMN IF NOT EXISTS year_of_study INT DEFAULT NULL;
ALTER TABLE files ADD COLUMN IF NOT EXISTS semester INT DEFAULT NULL;
ALTER TABLE files ADD COLUMN IF NOT EXISTS approval_status ENUM('PENDING','APPROVED','REJECTED') DEFAULT 'APPROVED';
ALTER TABLE files ADD COLUMN IF NOT EXISTS reviewed_by INT DEFAULT NULL;
ALTER TABLE files ADD COLUMN IF NOT EXISTS reviewed_at DATETIME DEFAULT NULL;
